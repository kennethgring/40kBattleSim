package com.example.application.calc;
...
//    }
     ...
     */
    public double calcAvgDamage(Attacker attacker, Weapon weapon, Defender defender) {
     ...
     */
    public int calcAvgModelsKilled(double avgDamage, Weapon weapon, Defender defender) {
        int modelsKilled = 0;
